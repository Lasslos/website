...
class ResponsiveWidget extends StatelessWidget {
  ...
  static bool isLargeScreenSize(BuildContext context) =>
      isScreenSize(context, largeScreenSize, double.infinity);
  static bool isMediumScreenSize(BuildContext context) =>
      isScreenSize(context, mediumScreenSize, largeScreenSize);
  static bool isSmallScreenSize(BuildContext context) =>
      isScreenSize(context, double.negativeInfinity, mediumScreenSize);

  static bool isScreenSize(
      BuildContext context, double lowerBound, double upperBound) {
